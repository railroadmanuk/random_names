...
var loops = flag.Int("loops",10,"number of records to generate")
...
func main(){
  ...
  for i := 0; i < *loops; i++ {
    ...
    fmt.Println(t,"\t\t",left[left_index],right[right_index])

    time.Sleep(time.Duration(*sleepLen) * time.Millisecond)
  }
}
